...
[![Android CI 状态](https://github.com/Quor-a/file-aci/workflows/Android%20CI/badge.svg)](https://github.com/Quor-a/file-aci/actions) [![GitHub 发行版](https://img.shields.io/github/v/release/Quor-a/file-aci)](https://github.com/Quor-a/file-aci/releases) [![许可证](https://img.shields.io/github/license/Quor-a/file-aci?color=blue)](LICENSE)

一个开源的 Material Design 文件管理器，适用于 Android 5.0+。

[<img alt="下载应用，请到 Google Play" src="https://play.google.com/intl/en_us/badges/static/images/badges/zh-cn_badge_web_generic.png" width="240">](https://play.google.com/store/apps/details?id=com.ai.assistance.quro.file) [<img alt="下载应用，请到 F-Droid" src="https://fdroid.gitlab.io/artwork/badge/get-it-on-zh-cn.png" width="240">](https://f-droid.org/packages/com.ai.assistance.quro.file) [<img alt="下载应用，请到 GitHub" src="https://raw.githubusercontent.com/Kunzisoft/Github-badge/main/get-it-on-github.png" width="240">](https://github.com/quro/FileAci/releases/latest/download/app-release-universal.apk)

[在 Transifex 上帮助翻译](https://www.transifex.com/quro/FileAci/)（[搜索 Android 和 GNOME 的翻译](https://translations.quro.me/)、[微软语言资源](https://learn.microsoft.com/en-us/globalization/reference/microsoft-language-resources)、[MIME 类型翻译](https://gitlab.freedesktop.org/xdg/shared-mime-info/-/tree/master/po)）
