...
[![Android CI status](https://github.com/Quor-a/file-aci/workflows/Android%20CI/badge.svg)](https://github.com/Quor-a/file-aci/actions) [![GitHub release](https://img.shields.io/github/v/release/Quor-a/file-aci)](https://github.com/Quor-a/file-aci/releases) [![License](https://img.shields.io/github/license/Quor-a/file-aci?color=blue)](LICENSE)

An open source Material Design file manager, for Android 5.0+.

[<img alt="Get it on Google Play" src="https://play.google.com/intl/en_us/badges/static/images/badges/en_badge_web_generic.png" width="240">](https://play.google.com/store/apps/details?id=com.ai.assistance.quro.file) [<img alt="Get it on F-Droid" src="https://fdroid.gitlab.io/artwork/badge/get-it-on.png" width="240">](https://f-droid.org/packages/com.ai.assistance.quro.file) [<img alt="Get it on GitHub" src="https://raw.githubusercontent.com/Kunzisoft/Github-badge/main/get-it-on-github.png" width="240">](https://github.com/quro/FileAci/releases/latest/download/app-release-universal.apk)

[Help translation on Transifex](https://www.transifex.com/quro/FileAci/) ([Search Android & GNOME translations](https://translations.quro.me/), [Microsoft language resources](https://learn.microsoft.com/en-us/globalization/reference/microsoft-language-resources), [MIME type translations](https://gitlab.freedesktop.org/xdg/shared-mime-info/-/tree/master/po))
...
- ACI (Agent-Controlled Interface): AI-readable file management capabilities for ZorvAI integration — list, read, write, search, archive files via structured API.
...
Thank you if you choose to include FileAci in your custom ROM! However since I've received several user complaints due to improper inclusion, I'd like to offer some suggestions on including this app properly for the good of end users:
