...
package com.ai.assistance.quro.file.theme.custom
...
import com.ai.assistance.quro.file.compat.recreateCompat
import com.ai.assistance.quro.file.compat.setThemeCompat
import com.ai.assistance.quro.file.compat.themeResIdCompat
import com.ai.assistance.quro.file.settings.Settings
import com.ai.assistance.quro.file.theme.night.NightModeHelper
import com.ai.assistance.quro.file.util.SimpleActivityLifecycleCallbacks
...
object CustomThemeHelper {
    ...
    private fun getCustomThemeRes(@StyleRes baseThemeRes: Int, context: Context): Int {
        ...
        val customThemeName = if (Settings.MATERIAL_DESIGN_3.valueCompat) {
            val defaultThemeName = resources.getResourceEntryName(R.style.Theme_FileAci)
            val material3ThemeName =
                resources.getResourceEntryName(R.style.Theme_FileAci_Material3)
