...
import com.ai.assistance.quro.file.compat.PreferenceManagerCompat
import com.ai.assistance.quro.file.compat.getDescriptionCompat
import com.ai.assistance.quro.file.compat.readBooleanCompat
import com.ai.assistance.quro.file.compat.writeBooleanCompat
...
import com.ai.assistance.quro.file.file.asExternalStorageUriOrNull
...
import com.ai.assistance.quro.file.navigation.StandardDirectorySettings
import com.ai.assistance.quro.file.provider.archive.ArchiveFileSystem
import com.ai.assistance.quro.file.provider.common.ByteString
import com.ai.assistance.quro.file.provider.common.moveToByteString
import com.ai.assistance.quro.file.provider.content.ContentFileSystem
import com.ai.assistance.quro.file.provider.document.DocumentFileSystem
import com.ai.assistance.quro.file.provider.document.resolver.ExternalStorageProviderHacks
import com.ai.assistance.quro.file.provider.linux.LinuxFileSystem
import com.ai.assistance.quro.file.provider.root.RootStrategy
import com.ai.assistance.quro.file.provider.sftp.SftpFileSystem
import com.ai.assistance.quro.file.provider.smb.SmbFileSystem
import com.ai.assistance.quro.file.storage.DocumentTree
import com.ai.assistance.quro.file.storage.FileSystemRoot
import com.ai.assistance.quro.file.storage.PrimaryStorageVolume
import com.ai.assistance.quro.file.util.StableUriParceler
import com.ai.assistance.quro.file.util.asBase64
import com.ai.assistance.quro.file.util.readParcelable
import com.ai.assistance.quro.file.util.readParcelableListCompat
import com.ai.assistance.quro.file.util.toBase64
import com.ai.assistance.quro.file.util.toByteArray
import com.ai.assistance.quro.file.util.use
        ...
        Parcel.obtain().use { newParcel ->
            ...
            Parcel.obtain().use { oldParcel ->
                ...
                repeat(size) {
                    ...
                    oldParcel.readInt()
                    val className = oldParcel.readString()
                    if (className == "com.ai.assistance.quro.file.storage.SmbServer") {
                        newParcel.writeInt(PARCEL_VAL_PARCELABLE)
                        newParcel.writeString("com.ai.assistance.quro.file.storage.SmbServer")
                        ...
                        newParcel.writeString(
                            "com.ai.assistance.quro.file.provider.smb.client.Authority"
                        )
                        ...
                        oldParcel.readString()
                        newParcel.writeString(
                            "com.ai.assistance.quro.file.provider.smb.client.Authentication"
                        )
...
private fun migratePath1_4_0(oldParcel: Parcel, newParcel: Parcel) {
    ...
    when (className) {
        ...
        "com.ai.assistance.quro.file.provider.sftp.SftpPath" ->
            newParcel.writeParcelable(oldParcel.readParcelable<SftpFileSystem>(), 0)
        "com.ai.assistance.quro.file.provider.smb.SmbPath" ->
            ...
            Parcel.obtain().use { oldParcel ->
                ...
                repeat(size) {
                    ...
                    when (oldParcel.readString()) {
                        "com.ai.assistance.quro.file.storage.SftpServer" -> {
                            newParcel.writeInt(PARCEL_VAL_PARCELABLE)
                            newParcel.writeString("com.ai.assistance.quro.file.storage.SftpServer")
                            val id = oldParcel.readLong()
                            newParcel.writeLong(id)
                            val customName = oldParcel.readString()
                            newParcel.writeString(customName)
                ...
                repeat(size) {
                    ...
                    when (oldParcel.readString()) {
                        "com.ai.assistance.quro.file.storage.SftpServer" -> {
                            ...
                            val authenticationPasswordOrPrivateKey = oldParcel.readString()
                            newParcel.writeString(authenticationPasswordOrPrivateKey)
                            if (authenticationClassName == "com.ai.assistance.quro.file.provider.sftp"
                ...
                Parcel.obtain().use { oldParcel ->
                    ...
                    readWriteLengthPrefixedValue(oldParcel, newParcel) {
                        ...
                        repeat(size) {
                            ...
                            oldParcel.setDataPosition(oldPosition)
                            when (className) {
                                "com.ai.assistance.quro.file.storage.DocumentManagerShortcut" -> {
                                    newParcel.writeInt(oldParcel.readInt())
                                    readWriteLengthPrefixedValue(oldParcel, newParcel) {
                                        oldParcel.readString()
                                        newParcel.writeString(
                                            "com.ai.assistance.quro.file.storage" +
